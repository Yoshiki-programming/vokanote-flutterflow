            ...
            child: Column(
              ...
              children: [
                          ...
                          child: ButtonWidget(
                            ...
                            action: () async {
                                  ...
                                  await showDialog<bool>(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: Text(
                                                'メールアドレスを「${_model.textFieldModel.textController.text}」に変更します。'),
                                            actions: [
                                              TextButton(
                              ...
                              if (confirmDialogResponse) {
                                if (_model.textFieldModel.textController.text
                                    .isEmpty) {
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            isDense: true,
                            labelText: FFLocalizations.of(context).getText(
                              'b44z62ax' /* 新しいパスワードをもう一度入力してください */,
                            ),
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                ...
                InkWell(
                  ...
                  onTap: () async {
                    context.pushNamed(AccountDeletePageWidget.routeName);
                  },
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'drlfp1kn' /* アカウントを削除 */,
