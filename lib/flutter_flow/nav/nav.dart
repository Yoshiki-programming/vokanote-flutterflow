...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? TopPageWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: TopPageWidget.routeName,
          path: TopPageWidget.routePath,
          builder: (context, params) => TopPageWidget(),
        ),
        FFRoute(
          name: AddPageWidget.routeName,
          path: AddPageWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => ContentPageWidget(
            vacabReference: params.getParam(
              'vacabReference',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['vocabs'],
            ),
          ),
        ),
        FFRoute(
          ...
          asyncParams: {
            'appConfigQuery':
                getDoc(['app_config'], AppConfigRecord.fromSnapshot),
          },
          builder: (context, params) => SignUpPageWidget(
            appConfigQuery: params.getParam(
              'appConfigQuery',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: AccountDeletePageWidget.routeName,
          path: AccountDeletePageWidget.routePath,
          builder: (context, params) => AccountDeletePageWidget(),
        ),
        FFRoute(
          name: UpdatePageWidget.routeName,
          path: UpdatePageWidget.routePath,
          asyncParams: {
            'vocaDocument': getDoc(['vocabs'], VocabsRecord.fromSnapshot),
          },
          builder: (context, params) => UpdatePageWidget(
            vocaDocument: params.getParam(
              'vocaDocument',
              ParamType.Document,
            ),
          ),
