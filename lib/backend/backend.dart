...
import 'schema/vocabs_record.dart';
...
export 'schema/vocabs_record.dart';
...
/// Functions to query VocabsRecords (as a Stream and as a Future).
Future<int> queryVocabsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VocabsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VocabsRecord>> queryVocabsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VocabsRecord.collection,
      VocabsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VocabsRecord>> queryVocabsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
