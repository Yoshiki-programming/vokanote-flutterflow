                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '391kdiv8' /* メールアドレスを入力してください。パスワード再設定用のリンク... */,
                            ),
                            ...
                            children: [
                              wrapWithModel(
                                ...
                                child: ButtonWidget(
                                  name: '変更する',
                                  action: () async {
                                    if (_model.textFieldModel.textController
                                        .text.isEmpty) {
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          ...
                                          content: Text(
                                              'パスワードリセット用リンクを送信しました。メールを確認してください。'),
                                          actions: [
                                            TextButton(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '95j84iw1' /* パスワード再設定用のリンクをメールアドレスにお送りしました。... */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
